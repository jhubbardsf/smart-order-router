...
export class AlphaRouter
  ...
  public async route(
    ...
    // from the same block.
    console.log("partialRoutingConfig.blockNumber", partialRoutingConfig.blockNumber);
    const blockNumber = process.env.BLOCK_NUMBER ? Number(process.env.BLOCK_NUMBER) : 26900127; // partialRoutingConfig.blockNumber ?? this.getBlockNumberPromise();
    console.log("Starting on block: ", blockNumber);
